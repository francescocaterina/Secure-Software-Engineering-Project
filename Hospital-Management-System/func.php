...
if(isset($_POST['patsub'])){
    ...
    // FIX SQLi: Utilizzo dei Prepared Statements per il login
...
if(isset($_POST['update_data'])) {
    ...
    // FIX SQLi: Utilizzo dei Prepared Statements per l'update
...
if(isset($_POST['doc_sub'])) {
    ...
    // FIX SQLi: Utilizzo dei Prepared Statements per l'insert
