    ...
    if($result->num_rows == 0){
        ...
        while($row = $result->fetch_assoc()){
            ...
            echo "<tr>
                ...
                <td>" . htmlspecialchars($row['doctor'], ENT_QUOTES, 'UTF-8') . "</td>
                <td>" . htmlspecialchars($row['docFees'], ENT_QUOTES, 'UTF-8') . "</td>
                <td>" . htmlspecialchars($row['appdate'], ENT_QUOTES, 'UTF-8') . "</td>
                <td>" . htmlspecialchars($row['apptime'], ENT_QUOTES, 'UTF-8') . "</td>
